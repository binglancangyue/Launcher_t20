package com.bixin.launcher_t20.model.bean;
...
public class WeatherDay {
    ...
    public String toString() {
        return "WeatherDay{" +
                ...
                ", comfortIndexDesc='" + comfortIndexDesc + '\'' +
                ", carWashIndex='" + carWashIndex + '\'' +
                ", carWashIndexDesc='" + carWashIndexDesc + '\'' +
                ", dressIndex='" + dressIndex + '\'' +
                ", dressIndexDesc='" + dressIndexDesc + '\'' +
                ", sunBlockIndex='" + sunBlockIndex + '\'' +
                ", sunBlockIndexDesc='" + sunBlockIndexDesc + '\'' +
                ", sportIndex='" + sportIndex + '\'' +
                ", sportIndexDesc='" + sportIndexDesc + '\'' +
                ", dryingIndex='" + dryingIndex + '\'' +
                ", dryingIndexDesc='" + dryingIndexDesc + '\'' +
                ", morningExerciseIndex='" + morningExerciseIndex + '\'' +
                ", morningExerciseIndexDesc='" + morningExerciseIndexDesc + '\'' +
                ", coldIndex='" + coldIndex + '\'' +
                ", coldIndexDesc='" + coldIndexDesc + '\'' +
                ", datingIndex='" + datingIndex + '\'' +
                ", datingIndexDesc='" + datingIndexDesc + '\'' +
                ", umbrellaIndex='" + umbrellaIndex + '\'' +
                ", umbrellaIndexDesc='" + umbrellaIndexDesc + '\'' +
                ", travelIndex='" + travelIndex + '\'' +
                ", travelIndexDesc='" + travelIndexDesc + '\'' +
                ", suggest='" + suggest + '\'' +
                '}';
    }
}